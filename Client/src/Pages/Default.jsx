...
<main class="bg-gray-50 dark:bg-gray-900">
  ...
  <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
      ...
      <div class="text-center xl:max-w-4xl">
          ...
          <a href="/" class="text-white bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
